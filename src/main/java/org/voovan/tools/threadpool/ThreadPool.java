...
public class ThreadPool {
	...
	private static ThreadPoolExecutor createThreadPool(){
		...
		ThreadPoolExecutor threadPoolInstance = new ThreadPoolExecutor(cpuCoreCount*50, cpuCoreCount*500,30, TimeUnit.MINUTES,new ArrayBlockingQueue<Runnable>(cpuCoreCount*500));

...
public class ThreadPool {
	...
	private static ThreadPoolExecutor createThreadPool(){
		...
		ThreadPoolExecutor threadPoolInstance = new ThreadPoolExecutor(cpuCoreCount*10, cpuCoreCount*500,1, TimeUnit.MINUTES,new ArrayBlockingQueue<Runnable>(cpuCoreCount*10000));

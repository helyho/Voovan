...
public class ThreadPool {
	...
	private static ThreadPoolExecutor createThreadPool(){
		...
		ThreadPoolExecutor threadPoolInstance = new ThreadPoolExecutor(cpuCoreCount*5, cpuCoreCount*50,1, TimeUnit.MINUTES,new ArrayBlockingQueue<Runnable>(cpuCoreCount*10000));

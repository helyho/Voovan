 ...
 */
public class RedisHashsWithList implements Closeable {
     ...
     */
    public RedisHashsWithList(String host, int port, int timeout, int poolsize, String name, String password){
        super();
     ...
     * @param name        在 redis 中的 HashMap的名称
     */
    public RedisHashsWithList(String host, int port, int timeout, int poolsize, String name){
        super();
     ...
     * @param name 在 redis 中的 HashMap的名称
     */
    public RedisHashsWithList(String name){

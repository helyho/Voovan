...
public class ContainerUnit extends TestCase {
    public void testAll() throws ReflectiveOperationException {
        ...
        //========test========
        System.out.println(container.getByAnchor("Filters[0].Name", ""));
        System.out.println("============================");

        container.addBeanValue("abcd", 123123);
        System.out.println(container.getByAnchor("abcd", 123));
        System.out.println("============================");

        container.getDefinitions().addBeanDefinition("config", Config.class, true, false, false);
        Config c = container.getByAnchor("co", null);
        ...
        System.out.println("method1 PathValue: " + container.getByAnchor("tttt1.ServerName", null));
        System.out.println("============================");
        ...
        System.out.println("static method3 PathValue: " + container.getByAnchor("tttt3", null));
        System.out.println("============================");
